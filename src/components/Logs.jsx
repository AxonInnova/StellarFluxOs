...
// logs viewer - displays available logs and lets u read them
      ...
      <div className="w-1/3 border-r border-stellar-accent/10 overflow-y-auto pr-3">
        ...
        {logs.map((log) => (
          <button
            ...
            className={`
              w-full text-left px-3 py-2 rounded mb-2 transition text-sm
      ...
      <div className="flex-1 overflow-y-auto">
        {selectedLog ? (
          <div>
            ...
            <div className="text-sm text-stellar-accent/80 font-mono whitespace-pre-wrap leading-relaxed">{selectedLog.content}</div>
          </div>
        ) : (
